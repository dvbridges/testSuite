pipeline {
    ...
    post {
        always {
            ...
            step([$class: 'WarningsPublisher', parserConfigurations: [[parserName: 'PYLint', pattern: 'pylint.out']], unstableTotalHigh: '10', unstableTotalNormal: '30', unstableTotalLow: '100', usePreviousBuildAsReference: true])
        }
    }
}